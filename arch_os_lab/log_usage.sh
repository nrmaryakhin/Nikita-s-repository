...
# Запрашиваем у пользователя количество файлов для архивации
read -p "Введите количество файлов для архивации: " FILE_COUNT
...
if [ "$current_usage" -ge "$THRESHOLD" ]; then
  ...
  files_to_archive=$(ls -tr "$LOG_DIR" | head -n $FILE_COUNT)
